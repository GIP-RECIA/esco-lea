...
$les_modalites_suivi_libre = $config_lea->get_modalites($declaration->type_suivi, 'rl', $declaration->id_periode);	
...
foreach ($les_arbres as $arbre ) {
	...
	$les_modalites_suivi =  $arbre->get_modalites('rl', $declaration->id_periode);
