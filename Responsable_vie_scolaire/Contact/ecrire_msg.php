...
/***********************************************************/
  ...
  // Version : 1.0
  // Date: 03/11/05
  // Contenu: Ce script permet d'afficher la lise des apprentis ayant un nom commence par le mot clé passé
  //           en paramettre
/***********************************************************/
...
$les_usagers = $unite->get_usagers($profil, $mot);
...
<form name="form1" method="post" action="<?php echo"contact.php?cmd=ecrire_msg"; ?>">
  <table width="48%" height="105">
    <tr class="cellule">
      <td width="39%" align="right">Profil</td>
      <td width="61%" height="23" align="left">
        <select name="profil" >
          <option value="app" <?php if($profil == 'app') echo"selected" ?> >Apprenti</option>
          <option value="ens" <?php if($profil == 'ens') echo"selected" ?> >Enseignant</option>
          <option value="ma" <?php if($profil == 'ma') echo"selected" ?> >Maitre
          apprentissage</option>
          <option value="rl" <?php if($profil == 'rl') echo"selected" ?> >Parent</option>
...
<form name="msgForm" action="<?php echo($LEA_URL."/administrateur/contact/ecrire_msg.php"); ?>" method="post" target="_blank" >
  ...
  <table width="81%" >
    ...
    <?php        
				...
				?>
    <tr>
      <td align="right" ><img src="../../images/arrow_ltr.png" width="38" height="22">&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td colspan="4"> <a href="#" onClick="select_all(true); return false;">Tout
          cocher</a> / <a  href="#" onClick="select_all(false); return false;">Tout
          d&eacute;cocher</a>&nbsp;&nbsp; pour la s&eacute;lection :
  ...
  <?php 
	...
	}elseif($mot_cle !="UNDEFINED" ) echo("Aucun usager n'est trouvé")
