...
-- 
-- Serveur: localhost
-- Généré le : Vendredi 23 Juin 2006 à 13:48
...
INSERT INTO `aide` VALUES (1, 'Construction de l''espace réservé à l''employeur pour le suivi de l''apprenti\r\n', 'Elaboration de l''environnement de suivi en entreprise');
INSERT INTO `aide` VALUES (2, 'L''apprenti pourra joindre des documents lorsqu''il saisira des données sur le site. Ces documents peut justifier ou apporter un complément d'' informations à la déclaration.\r\nOn entend par déclaration l''action de saisir des données sur le site.', 'Joindre des fichiers à la déclaration');
INSERT INTO `aide` VALUES (3, 'Déterminer le nombre de jours, selon le calendrier scolaire de la classe, durant lequel l''apprenti pourra remplir sa déclaration. Il disposera encore de 15 jours d''échéances, après la date de fin prévue, pour remplir sa déclaration sur le site.', 'La durée d''activation d''une déclaration');
INSERT INTO `aide` VALUES (4, 'La déclaration d''activités libre rend l''apprenti, ou tout autre acteur, libre d''inscrire ses appréciations. Il devra saisir des données brutes qui ne seront pas sujettes à des statistiques. L''apprenti complétera des champs de textes, ou des listes de choix.', 'Déclaration d''activités libre');
INSERT INTO `aide` VALUES (5, 'La déclaration d''activités guidée avec un référentiel (arborescence) oriente l''apprenti, ou tout autre acteur, en lui proposant de compléter des données. Il devra suivre une arborescence que vous aurez initialisé. Les données renseignées permettront d''effectuer des statistiques et ainsi, d''évaluer les apprentis selon des critères de performance. \r\nLe terme statistique est relatif au critère de performance attendu de l''apprenti. Par exemple, le responsable de la formation aura mentionné que l''apprenti devra effectuer une tache 10 fois. Une espérance que l''apprenti tentera de valider en notifiant chaque fois que l''action a été effectuée. A la fin de la période, les suiveurs de l''élève pourront observer les performances réalisées, comparées aux espérances.\r\n', 'Déclaration d''activités guidée avec un référentiel');
INSERT INTO `aide` VALUES (6, 'Conditions à compléter sous forme de champ de saisie ou à cocher afin d''apporter des informations', 'Modalités');
INSERT INTO `aide` VALUES (7, 'Déterminer les critères de suivi de l''apprenti en établissant des rubriques que soit le maître d''apprentissage, le parent, le tuteur, l''enseignant de la formation, le responsable de la formation, ou encore  l''apprenti lui même, devra compléter', 'Elaboration de l''environnement de suivi libre en entreprise');
INSERT INTO `aide` VALUES (8, 'Personnes concernées par les conditions à renseigner', 'Cible des modalités');
INSERT INTO `aide` VALUES (9, '', 'Titre de la modalité');
...
INSERT INTO `aide` VALUES (12, 'Modifier les critères de cet espace de suivi (titre, personnes concernées, choix, etc)', 'Modifier cette modalité');
INSERT INTO `aide` VALUES (13, 'Supprimer les conditions de l''espace de suivi affiché', 'Suprimer une modalité');
INSERT INTO `aide` VALUES (14, 'Créer une autre espace de suivi, avec de nouvelles conditions et de nouveaux critères', 'Créer une nouvelle modalité');
INSERT INTO `aide` VALUES (15, 'Donnez un titre significatif à la zone de suivi que vous allez créer ', 'Nouvelle modalité de saisie');
INSERT INTO `aide` VALUES (16, 'Déterminer la personne destinée à compléter la rubrique', 'Nouvelle modalité de saisie');
INSERT INTO `aide` VALUES (17, 'Etablir les périodes d''activité de la modalité', 'Nouvelle modalité de saisie');
INSERT INTO `aide` VALUES (18, 'Choisir si  l''utilisateur aura une zone de texte à remplir ou le choix entre divers propositions préétablies', 'Nouvelle modalité de saisie');
INSERT INTO `aide` VALUES (19, 'Nombre de réponses que pourra cocher l''utilisateur concernant  cette modalité', 'Liste de choix');
...
INSERT INTO `aide` VALUES (23, 'La déclaration d''activités guidée avec un référentiel oriente l''apprenti, ou tout autre acteur, en lui proposant de compléter des données. Il devra suivre une arborescence que vous aurez initialisé. Les données renseignées permettront d''effectuer des statistiques et ainsi, d''évaluer les protagonistes (apprentis, etc) selon des critères de performance. \r\nLe terme statistique est relatif au critère de performance attendu de l''apprenti. Par exemple, le responsable de la formation aura mentionné que l''apprenti devra effectuer une tache 10 fois. Une espérance que l''apprenti tentera de valider en notifiant chaque fois que l''action a été effectuée. A la fin de la période, les suiveurs de l''élève pourront observer les performances réalisées, comparée aux espérances.', 'Création d''un arbre pour le suivi guidé en entreprise');
INSERT INTO `aide` VALUES (24, 'L''arbre correspond à la forme adoptée pour référencier les données. Un thème, ou ensemble, représente un tronc qui se décompose en différentes branches correspond aux niveaux chronologiques à compléter par les protagonistes. Chaque branche se décompose en feuilles, ou taches, finalités de l''arbre.', 'L''arbre');
...
INSERT INTO `aide` VALUES (40, 'La validation consiste à confirmer la forme des modalités saisie établies précédement. La validation à pour objectif d''apporter des précisions aux déclarations. Vous pouvez ainsi définir un type de réponse (numérique, texte, etc) pour une période donnée.', 'Valider l''arbre');
...
INSERT INTO `les_chartes_graphiques` VALUES (1, 'Métal_alu_verre_logo_.gif', '', 'Métal_alu_verre_img_accueil_.png', 16);
...
INSERT INTO `les_configs_lea` VALUES (1, 0x31, 0x30, 0x31, 0x31, 'maitre apprentissage', 'TUTEUR', 15, 15, 0x30, 0x31, 16);
...
INSERT INTO `les_documents_declares` VALUES (7, 'coordonnées_.jpg', 0x31, 5);
...
INSERT INTO `les_evaluations_feuilles_modalite_choix` VALUES (3, 99, 3);
...
INSERT INTO `les_feuilles_declarees_modalite_va_unique` VALUES (91, 5, 10, 'wxc');
...
INSERT INTO `les_messages` VALUES (12, 'merci', 'j''ai bien noté', '2006-06-22 15:38:48', '0000-00-00', 20867);
...
INSERT INTO `les_messages_recus_usagers` VALUES (12, 20896, 'OUI', 'NON');
...
INSERT INTO `les_options` VALUES ('LEA_BACKGROUND_HEAD', 'LEA_BACKGROUND_HEAD.png');
INSERT INTO `les_options` VALUES ('LEA_THEME', 'default');
...
INSERT INTO `les_usagers` VALUES (1116, 'Monsieur', 'admin', 'admin', '32 av de chanzy', '', '', '', '', 'admin', '2006-02-23', '2006-06-23 11:20:27', 305, 0, '0000-00-00', '0000-00-00', 'aadmin', '123456', NULL);
INSERT INTO `les_usagers` VALUES (20867, 'Monsieur', 'BAINBRIDGE', 'Daniel', 'LE MOULIN A VENT\r\n\r\n53340   COSSE-EN-CHAMPAGNE', '02-43-67-83-32', '', '', '', 'app', '2006-05-22', '2006-06-22 16:59:45', 40, 0, '0000-00-00', '0000-00-00', 'DBAINBRIDGE', '123456', 'img_accueil_20867_portail.jpeg');
...
INSERT INTO `les_usagers` VALUES (20895, 'Madame', 'BAINBRIDGE', 'SUZANNE', 'LE MOULIN A VENT\n\n53340   COSSE-EN-CHAMPAGNE', '02-43-67-83-32', '', '', '', 'rl', '2006-05-22', '2006-06-20 15:44:32', 2, 0, '0000-00-00', '0000-00-00', 'SUZANNE_BAINBRIDGE', 'MUHZya', NULL);
INSERT INTO `les_usagers` VALUES (20896, 'Monsieur', 'ANGOT', 'Fabien', 'Le Chêne\r\n\r\n53290   GREZ EN BOUERE', '02-43-70-91-76', '', '', 'http://', 'ens', '2006-05-22', '2006-06-23 11:20:44', 71, 0, '0000-00-00', '0000-00-00', 'FANGOT', '123456', NULL);
INSERT INTO `les_usagers` VALUES (20897, 'Monsieur', 'DALIBARD', 'Jacky', 'ZA LES VIGNES\n\n72300   SABLE-SUR-SARTHE', '02-43-62-12-00', '', '', '', 'ma', '2006-05-22', '2006-06-22 10:21:03', 10, 0, '0000-00-00', '0000-00-00', 'Jacky_DALIBARD', 'buUmpa', NULL);
...
INSERT INTO `les_usagers` VALUES (20914, 'Monsieur', 'rvs', 'rvs', 'rvs', '', '', '', '', 'rvs', '2006-06-06', '2006-06-06 15:41:59', 1, 0, '0000-00-00', '0000-00-00', 'rvsrvs', '123456', NULL);
