...
<!-- InstanceBeginEditable name="sous_menu" -->
					...
					<div id="texte">              
		            	...
		            	<?php  if($suivi!="false"){   ?> <li class="configSuivi"> <a href="options.php?cmd=suivi_entr"> Configurer : <?php echo $config_lea->appelation_suivi_entr; ?> </a> <a href="#" onclick="lightbox('aide_43', '<?php echo $LEA_URL?>')"> <img src="<?php echo($LEA_URL.'themes/'.$_SESSION['options_lea']['LEA_THEME'].'/images/ico_aide.gif'); ?>" border="0" /> </a> </li> <?php  }  ?>
      <li class="configSuivi"> <a href="options.php?cmd=suivi_cfa"> Configurer : <?php echo $config_lea->appelation_suivi_cfa; ?> </a> <a href="#" onclick="lightbox('aide_44', '<?php echo $LEA_URL?>')"> <img src="<?php echo($LEA_URL.'themes/'.$_SESSION['options_lea']['LEA_THEME'].'/images/ico_aide.gif'); ?>" border="0" /> </a> </li>						</ul>
		       		</div></div>
<!-- InstanceEndEditable --> 
				</div>
