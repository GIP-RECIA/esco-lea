...
/***********************************************************/
  ...
  // Version : 1.0
  // Date: 06/09/05
  // Contenu:  Ce script permet la mise ï¿½ jours de la liste des enseignants de la formation
  // 			dont l'identifiant est enregistrï¿½e dans la session.
...
elseif (isset($_REQUEST['mot_cle']) )  $mot_cle = $_REQUEST['mot_cle'];
 ...
 ?>
			<div id="top_l"></div><div id="top_m"><h1><span class="orange">L</span>es <?php echo $config_lea->appelation_ens ?>s de votre <?php echo $config_term->terminologie_formation; ?></h1></div><div id="top_r"></div>
			<div id="m_contenu">
<?php Afficher_recherche("options.php", $mot_cle, array("cmd" =>"modifier_liste_enseignants")); ?>
