...
<div id="top_m">
	<?php
		if ($action != "modif") {
			echo "<h1><span class='orange'>A</span>jouter ".$config_term->terminologie_rl."</h1>";
		} else {
			echo "<h1><span class='orange'>M</span>odifier ".$config_term->terminologie_rl."</h1>";			
		}
	?>
</div>
<div id="top_r"></div>
...
<?php echo"
    ...
    <td class="cellule">
        ...
        <input name='droit[]' type='radio' value='rl' checked> <?php echo $config_term->terminologie_rl;?>
