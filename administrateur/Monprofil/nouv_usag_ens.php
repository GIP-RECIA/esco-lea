...
/***********************************************************/	
if(isset($_REQUEST['action'])) $action=$_REQUEST['action']; // l'action demandï¿½e : mofier ou ajouter un nouvel enseignant
else $action="";
...
<div id="top_l"></div>
<div id="top_m">
	<h1><span class="orange">A</span>jouter : <?php echo $config_term->terminologie_ens; ?></h1>
</div>
<div id="top_r"></div>
<div id="m_contenu"> 
<?php echo"
	<form name='theForm' action='form_nouv_usag_v.php?id_usager=$id_ens&profil=ens&action=$action' method='post' onsubmit='return controleSaisie(this)'>" ?>
		<table width="69%" height="62%" border="0" cellpadding="0" cellspacing="0" >
			...
			<tr>
			  	...
			  	<td><input name="tel_mobile" type="text" value='<?php echo $enseignant->tel_mobile;?>'></td>
			</tr>
			<tr>
			  	<td height="22">E-mail </td>
			  	<td><input name="email" type="text" value='<?php echo $enseignant->email;?>'></td>
			</tr>
			<tr>
			  	<td height="18">Site web(url)</td>
			  	<td><input name="url_site" type="text"value='<?php echo $enseignant->url_site;?>'></td>
			</tr>
			<tr>
			  	<td height="25">Discipline</td>
			  	<td><input name="discipline" type="text" value='<?php echo $enseignant->discipline;?>' size="50"></td>
			</tr>
			<tr>
			...
			<tr>
			  	...
			  	<td>
			  		<input name="login" type="text" value='<?php echo $enseignant->login;?>' onFocus=" auto_login(document.theForm)">
			      	<sup class="etoile">*</sup> 
			    </td>
			</tr>
			<tr>
			  	...
			  	<td>
			  		<input name="mdp" type="password" value='<?php echo $enseignant->mdp;?>'  >
			      	<sup class="etoile">*</sup> 
			    </td>
			</tr>
			<tr>
			  	...
			  	<td>
			    	<input name="confirm_mdp" type="password" value='<?php echo $enseignant->mdp;?>'  >
			    	<sup class="etoile">*</sup> 
			   	</td>
			</tr>
			<tr>
