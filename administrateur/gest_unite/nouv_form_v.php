...
$formation->id_unite = to_sql($_REQUEST['id_unite']);
//------------------- enregistrement de la formation sur la base de donnï¿½es ------------------	
...
html_refresh("gest_unite.php?cmd=cons_form&id_unite_select=".$formation->id_unite);
