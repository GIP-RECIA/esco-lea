...
if(isset($_REQUEST['id_for']) || isset($_SESSION['id_ens'])) { 
	...
	$est_enseignant_formation = $enseignant->est_enseignant_formation($_SESSION['id_for']) 
	 								||
	 							   $enseignant->est_responsable($_SESSION['id_for']); 
