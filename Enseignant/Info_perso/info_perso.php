...
<div  id="<?php  if(!isset($_REQUEST['imprimer'])){
		...
		case "cons_coordonnees": afficher_sous_menu("cons_coordonnees"); 
								include('cons_coordonnees.php');  // consulter les coordonnï¿½es de l'apprenti
							  break;	
		case "modif_coordonnees": afficher_sous_menu("modif_coordonnees"); 
								 include('modif_coordonnees.php');  // formulaire pour modifier les coordonnï¿½es de l'apprenti
							  	break;		
							  					  						  
		default             :  afficher_sous_menu("cons_coordonnees"); 
								include('cons_coordonnees.php');  // consulter les coordonnï¿½es de l'apprenti
							  break;					  	        		
