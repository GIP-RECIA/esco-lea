...
<div id="m_contenu">
	...
	<form action="../../interface_formation_v.php" method="post">
		<table id="table_func" class="table_layout">
			...
			<tr>
				<td colspan="3" class="aide">
					<!-- Déplacez une image pour ajouter cette fonctionnalité un acteur. --> 
					Vous pouvez agrandir une fonctionnalité pour voir ce qu'elle permet de faire.
				</td>
			</tr>
		</table>
			...
			<tr>
				<td>
					<div class="act" id="act_ens">
						...
						<div class="act_name">
							<img src="param/petit_logo_ens.png" alt="<?php echo $config_lea->appelation_ens; ?>" />
							<input type="text" class="act_text" name="term_ens" value="<?php echo $config_lea->appelation_ens; ?>" />
							<input type="text" class="act_text" name="term_tuteur_cfa" value="<?php echo $config_lea->appelation_tuteur_cfa; ?>" style="display:none; margin-top:4px; width:190px" />
						</div>
				...
				<td>
					<div class="act" id="act_ma">
						<div class="act_name">
							<img src="param/petit_logo_ma.png" alt="<?php echo $config_lea->appelation_ma; ?>" />
							<input type="text" class="act_text" name="term_ma" value="<?php echo $config_lea->appelation_ma; ?>" />
						</div>
						<?php
				...
				<td>
					<div class="act" id="act_rl">		
						<div class="act_name">
							<img src="param/petit_logo_rl.png" alt="<?php echo $config_lea->appelation_rl; ?>" />
							<img src="param/suppression.jpg" alt="Supprimer" class="suppression" id="supp_rl" />
							<input type="text" class="act_text" name="term_rl" value="<?php echo $config_lea->appelation_rl; ?>" />
						</div>
						<?php
			...
			<tr>
				...
				<td colspan="2">
					<div class="act" id="act_app">
						<div class="act_name">
							<img src="param/petit_logo_app.png" alt="<?php echo $config_lea->appelation_app; ?>" />
							<input type="text" class="act_text" name="term_app" value="<?php echo $config_lea->appelation_app; ?>" />
						</div>
						<?php
			...
			<tr>
				<td>
					...
					<div class="inst_detail">
						...
						<div class="inst">
							<input type="text" class="act_text" name="term_classe" value="<?php echo $config_lea->appelation_classe; ?>" />
						</div>
					</div>
				...
				<td id="inst_entr">
					<div class="inst_detail">
						<input type="text" class="act_text" name="term_entr" value="<?php echo $config_lea->appelation_entr; ?>" />
					</div>
				</td>
			</tr>
			<tr class="marge">
				<td>
					<div class="inst">
						<input type="text" class="act_text" name="term_suivi_cfa" value="<?php echo $config_lea->appelation_suivi_cfa; ?>" />
					</div>
				</td>
				<td>
					<div class="inst">
						<img src="param/suppression.jpg" alt="Supprimer" class="suppression" id="supp_suivi_entr" />
						<input type="text" class="act_text" name="term_suivi_entr" value="<?php echo $config_lea->appelation_suivi_entr; ?>" />
					</div>
				</td>
			</tr>
		</table>
		...
		<input type="hidden" id="input_supp_suivi_entr_lea" value="<?php echo $suivi; ?>" />
		<input type="hidden" id="input_supp_rl" name="supp_rl" value="<?php echo isset($parent_for) ? $parent_for : $parent; ?>" />
		<input type="hidden" id="input_supp_rl_lea" value="<?php echo $parent; ?>" />
	...
	<div style="visibility:hidden; height:1px;">
		...
		<img src="param/activation.jpg" alt="prechargement" />
		<img src="param/interdiction.jpg" alt="prechargement" />
	</div>
</div>