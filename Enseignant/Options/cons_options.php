...
<div id="m_contenu">
  <div id="texte">
    ...
    <ul class="menuConfig">
      ...
      <li class="param" > <a href="<?php echo"options.php?cmd=terminologie"?>">Paramétrage</a> </li>
	<li class="termino">
			<a href="<?php echo($LEA_URL.'Enseignant/Donner/donner.php') ?>">Groupe de concepteurs</a>
		</li>
