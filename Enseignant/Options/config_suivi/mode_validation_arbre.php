...
// Cette fonction visualise la presentation de la  modalite  $modalite
...
function afficher_modalite($modalite){
	...
	switch($classe){		
		case "modalite_va_unique" : 
			...
			$lien_modif =
				"<a href ='#' 
				onClick=\"window.open('./config_suivi/modifier_modalite_va_unique.php?id_modalite=$modalite->id_modalite','','width=970, height=500, resizable=yes, scrollbars=yes' )\" > 
		...
		case "modalite_va_multiple"		   :								
			...
			$lien_modif =
				"<a href ='#' 
				onClick=\"window.open('./config_suivi/modifier_modalite_va_multiple.php?id_modalite=$modalite->id_modalite','','width=970, height=500, resizable=yes, scrollbars=yes' )\" > 
			 	Modifier cette modalit&eacute;
				</a>";
			$lien_supp = 
	...
	if( count($les_periodes) > 0  ) {
		...
		$str_periodes = to_html("Aucune période ");
	}	
	...
	<table>
		...
		<tr>
			<td height="29" class="center"> <br/>
				...
				<a href="#" 
					onClick="window.open('config_suivi/creer_modalite_validation_arbre.php?<?php echo"id_arbre=$arbre->id_arbre"."&acteur=$acteur" ?>' , '', 'width=970, height=540, resizable=yes,  scrollbars=yes' )"> 
