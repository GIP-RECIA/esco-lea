...
?>
<div id="box2" style="display: none"><?php include($LEA_REP.'Enseignant/sel_formation.php'); ?></div>
<?php
...
switch ($cmd) {
	...
	case "exporter":
		include ("./config_suivi/exporter_arbre.php");
		break;

	case "dupliquer_periode":
		include ("./dupliquer_periode.php");
		break;
