...
if($id_dec == 0){ // il s'agit d'une nouvelle dï¿½claration
...
$les_modalites_suivi_libre_app = $config_lea->get_modalites($declaration->type_suivi, 'app', $declaration->id_periode);
$les_modalites_suivi_libre_tuteur = $config_lea->get_modalites($declaration->type_suivi, 'tuteur_cfa', $declaration->id_periode);
$les_modalites_suivi_libre_ens = $config_lea->get_modalites($declaration->type_suivi, 'ens', $declaration->id_periode);
$les_modalites_suivi_libre_rf = $config_lea->get_modalites($declaration->type_suivi, 'rf', $declaration->id_periode);


if($est_responsable) {
	$les_modalites_suivi_libre = array_merge(
		$les_modalites_suivi_libre_app,
		$les_modalites_suivi_libre_tuteur,
		$les_modalites_suivi_libre_ens,
		$les_modalites_suivi_libre_rf	
											);	
}
elseif($est_tuteur){
	$les_modalites_suivi_libre = array_merge(												
...
else $les_modalites_suivi_libre = $les_modalites_suivi_libre_ens;
...
foreach ($les_arbres as $arbre ) {
	...
	$les_modalites_suivi_guide_app = $arbre->get_modalites('app', $declaration->id_periode);
	$les_modalites_suivi_guide_tuteur = $arbre->get_modalites('tuteur_cfa', $declaration->id_periode);
	$les_modalites_suivi_guide_ens = $arbre->get_modalites('ens', $declaration->id_periode);
	$les_modalites_suivi_guide_rf = $arbre->get_modalites('rf', $declaration->id_periode);
	
	if($est_responsable) {
		$les_modalites_suivi = array_merge(
			$les_modalites_suivi_guide_app,
			$les_modalites_suivi_guide_tuteur,
			$les_modalites_suivi_guide_ens,
			$les_modalites_suivi_guide_rf	
											);	
	}
	elseif($est_tuteur){
		$les_modalites_suivi = array_merge(												
	...
	else $les_modalites_suivi = $les_modalites_suivi_guide_ens;
