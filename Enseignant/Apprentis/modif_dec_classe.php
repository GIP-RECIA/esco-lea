...
$les_modalites_suivi_guide = $arbre->get_modalites('app');

$les_modalites_suivi_libre = $config_lea->get_modalites($declaration->type_suivi, 'app');
...
html_refresh("livret.php?cmd=nouv_dec_ref");
