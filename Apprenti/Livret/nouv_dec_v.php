	...
	if(isset($_FILES['fichier'])) {
			...
			if  (move_uploaded_file($src, $SRC_DOCUMENTS_DECLARES.$dest)) { 						 		 		 		
				if ($dest!=""){                 
					...
					$document->id_usager = $_SESSION['id_app'] ;		
					$document->insert(); 										
				}	
			}
	}	
...
$_SESSION['les_feuilles_declarees'] = NULL;
$_SESSION['validation_feuille_modalite_va_unique'] = NULL;
$_SESSION['validation_feuille_modalite_va_multiple'] = NULL;
...
html_refresh("livret.php?cmd=cons_dec&type_suivi=$type_suivi&id_periode=$declaration->id_periode");
