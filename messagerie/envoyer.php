...
$msg_reponse->update_reponse($msg->id_usager); // l'usager ayant ï¿½crit le message $msg a rï¿½pondu au message d'identifiant $id_msg_reponse
...
if($msg->objet == "")  $msg->objet = "[n&eacute;ant]";
	...
	if(isset($_FILES['fichier_joint'])) {
			 ...
			 $src = $_FILES['fichier_joint']['tmp_name']; // nom du nouvau fichier tï¿½lechargï¿½ sur le tempo de serveur
			 $nom = $_FILES['fichier_joint']['name'];// nom  du nouvau fichier tï¿½lechargï¿½ sur le poste client						 
...
if (isset($_REQUEST['mail']) && $_REQUEST['mail'] == 'on')
	$msg->envoyer_mail($_REQUEST['les_id_usager_dest'], $msg->usager, $msg->objet);
...
<body>
        <table width="100%" height="2%" border="0" cellpadding="0" cellspacing="0" >   
          <tr align="center">
            <td height="18" >
			<?php echo"Votre message a bien &eacute;t&eacute; envoy&eacute; <br /><br />"; afficher_boutton_fermer(0); ?>
			</td>
          </tr>
	</table>
